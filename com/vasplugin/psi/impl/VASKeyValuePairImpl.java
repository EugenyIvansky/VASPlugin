...
public class VASKeyValuePairImpl extends VASContributedReferenceHostImpl implements VASKeyValuePair {

  public VASKeyValuePairImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof VASVisitor) ((VASVisitor)visitor).visitKeyValuePair(this);
